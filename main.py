...
while should_continue:
  ...
  is_correct = compare(follower_a,follower_b,guess)

  if is_correct:
    score+= 1
    print(f"Yay you are right, Current score : {score}")
    compare(follower_a,follower_b,guess)
    clear()
  else:
    should_continue = False
    print(" You chose wrong one")
